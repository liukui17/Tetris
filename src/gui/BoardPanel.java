...
public class BoardPanel extends JPanel {
	...
	public BoardPanel(boolean drawGhosts, int numPlayers, int playerNum) {
		...
		this.setPreferredSize(new Dimension(GameUtil.BOARD_WIDTH * CELL_LENGTH, GameUtil.BOARD_HEIGHT * CELL_LENGTH + 100));
		this.setMinimumSize(new Dimension(GameUtil.BOARD_WIDTH * CELL_LENGTH, GameUtil.BOARD_HEIGHT * CELL_LENGTH + 100));
